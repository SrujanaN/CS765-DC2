...
#
# fig.add_trace(
#     go.Scatter(x=list(customer_reviews.keys()), y=list(customer_reviews.values()), mode='lines', name='Reviews'
#                ), secondary_y=False,)
#
# fig.add_trace(
#     go.Scatter(x=list(customer_reviews.keys()), y=list(customer_rating.values()), name='Average rating'),
#     secondary_y=True,)
# # Set x-axis title
